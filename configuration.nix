...
# Aliases (for bash -- Konsole)
programs = {
  command-not-found.enable = false;

  # Add Bash (Konsole) aliases
  bash = {
    shellAliases = {
      gotoknox = "sshfs obi@jellyfin-nixos:/home/obi/media /home/obi/media";
      rebuild = "sudo nixos-rebuild switch";
      upgrade = "sudo nixos-rebuild switch --upgrade";
      garbage = "sudo nix-collect-garbage --delete-older-than 30d";
    };
  };
};
